...
*/}
      <div className="flex flex-wrap sm:gap-x-6 items-center justify-center">
        ...
        <div className="stats bg-primary shadow">
          <div className="stat">
            <div className="stat-title text-primary-content text-4xl fon-bold tracking-widest">
              comfy
            </div>
          </div>
        </div>
      ...
      <p className="mt-6 max-w-2xl mx-auto leading-8 text-lg">
        ...
        facere esse ratione eos voluptatem ea perspiciatis quidem eum alias, ex
        reprehenderit molestias quasi explicabo sed eaque distinctio inventore
        harum accusantium, excepturi quibusdam, reiciendis quas. Non nesciunt
